 ...
 * 
 * Die main.c sorgt ueber eine Zustandsmaschine für einen geregelten 
 * Programmfluss. Von hier werden die anderen Bibliotheken aufgerufen. 
 * 
 * Disclaimer: Teile des Codes wurden mit ChatGPT debugt.
 */
...
char currentMessage[MAX_MESSAGE_LENGTH];
    ...
    while (1) {
        ...
        switch (currentState) {
            case STATE_PLACE_SHIPS:
                ...
                myNumber = rand() % 100; //Zufallszahl zwischen 0-99;
                ...
                sprintf((char *)currentMessage, "RDY%d", myNumber);
                    ...
                    sprintf((char *)currentMessage, "RDY0%d", myNumber);
                }
